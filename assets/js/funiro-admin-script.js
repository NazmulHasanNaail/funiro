jQuery(document).ready(function($){
  ...
  $(".funiro-repeater-field-control-wrap").sortable({
    orientation: "vertical",
    update: function( event, ui ) {
      funiro_refresh_repeater_values();
    }
  });
    /**
     * Section re-order
    */
    ...
    //Scroll to section
    $('body').on('click', '#sub-accordion-panel-funiro_homepage_settings .control-subsection .accordion-section-title', function(event) {
